function sendEmailWarningMargin2() {
  ...
  if (errorStatus<.20 && errorStatus>.01 && errorCheck === false){
    ...
    // Send Alert Email.
    var message = 'Warning in Margin Loan Payment/Interest Schedule spreadsheet, "2 - Summary" tab (https://docs.google.com/spreadsheets/d/1VIMroeCLz7VhWoUNvLd8jZmn1VYBB0ANc2BPlNZN4AA/edit?gid=1783973611#gid=1783973611), Drawdown remaining has dropped below 20% !'; // Second column
